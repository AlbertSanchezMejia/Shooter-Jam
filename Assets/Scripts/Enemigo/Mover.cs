...
public class Mover : MonoBehaviour
{
    ...
    void Update()
    {
        if (Vector3.Distance(destinations[currentDestination].transform.position, transform.position) < 0.6f) // Controla cuando alcanza el destino actual (no es recomendable poner "igual a 0")
        {
        ...
        nav.destination = currentTarget; // Asigna el objetivo al que debe ir, ya sea destino o jugador
    }
}
