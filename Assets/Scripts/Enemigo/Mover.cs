...
public class Mover : MonoBehaviour
{
    ...
    void Update()
    {
        if (Vector3.Distance(destinations[currentDestination].transform.position, transform.position) < 0.5f) // Controla cuando alcanza el destino actual (no es recomendable poner "igual a 0")
        {
